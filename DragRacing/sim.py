...
def SimVehicle(y0, controller, integrator, car_dynamics, N_sim, MPC = False, x0_nlp_in = None, lamx0_nlp_in = None, lamg0_nlp_in = None, is_silent=False):
    ...
    if MPC:
        prob, N_mpc, n_x, n_g, n_p, lb_var, ub_var, lb_cons, ub_cons = controller()
